// Minimal static server for the pawspital mockup.  usage: node server.js [port]
...
http.createServer((req, res) => {
  ...
  if (p === '/') p = '/pawspital/pawspital.html';
...
}).listen(PORT, () => console.log('pawspital -> http://localhost:' + PORT + '/pawspital/pawspital.html'));

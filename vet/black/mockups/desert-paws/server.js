// Minimal static server for the desert-paws mockup.  usage: node server.js [port]
...
http.createServer((req, res) => {
  ...
  if (p === '/') p = '/desert-paws/desert-paws.html';
...
}).listen(PORT, () => console.log('desert-paws -> http://localhost:' + PORT + '/desert-paws/desert-paws.html'));

// Minimal static server for the harbor-paws mockup.  usage: node server.js [port]
...
http.createServer((req, res) => {
  ...
  if (p === '/') p = '/harbor-paws/harbor-paws.html';
...
}).listen(PORT, () => console.log('harbor-paws -> http://localhost:' + PORT + '/harbor-paws/harbor-paws.html'));

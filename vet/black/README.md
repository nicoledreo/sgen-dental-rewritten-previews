# SGEN — Veterinary Local SEO + AEO · Black (dark)

Retarget of `SGEN-SEO-AEO-Dental_Black_Optimized_V4` from **dental** to **veterinary / animal clinics / animal hospitals**.
...
Bundle: **294 files, 10,465,212 bytes.**
...
- Theme: `body` computes to `rgb(10, 9, 11)`; light-theme block absent (dark build); logos sgen-logo.png x8, sgen-logo-3.webp x5 —
  matching the black (dark) reference exactly.

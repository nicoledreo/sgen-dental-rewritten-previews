// Minimal static server for the beacon-animal-hospital mockup.  usage: node server.js [port]
...
http.createServer((req, res) => {
  ...
  if (p === '/') p = '/beacon-animal-hospital/beacon-animal-hospital.html';
...
}).listen(PORT, () => console.log('beacon-animal-hospital -> http://localhost:' + PORT + '/beacon-animal-hospital/beacon-animal-hospital.html'));

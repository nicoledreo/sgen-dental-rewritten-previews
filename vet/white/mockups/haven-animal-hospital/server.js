// Minimal static server for the haven-animal-hospital mockup.  usage: node server.js [port]
...
http.createServer((req, res) => {
  ...
  if (p === '/') p = '/haven-animal-hospital/haven-animal-hospital.html';
...
}).listen(PORT, () => console.log('haven-animal-hospital -> http://localhost:' + PORT + '/haven-animal-hospital/haven-animal-hospital.html'));

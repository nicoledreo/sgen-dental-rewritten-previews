...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'kidspark-dental.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Kidspark Dental server running on http://localhost:${PORT}`));

...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'pearl-dental-studio.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Pearl Dental Studio server running on http://localhost:${PORT}`));

...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'bright-smile-dental.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Bright Smile Dental server running on http://localhost:${PORT}`));

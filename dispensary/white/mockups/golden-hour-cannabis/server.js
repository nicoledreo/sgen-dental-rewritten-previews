...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'golden-hour-cannabis.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Golden Hour Cannabis server running on http://localhost:${PORT}`));

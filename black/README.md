# SGEN Dental (Dark) — Local SEO + AEO Landing Page

**Dark/black-theme** editable static clone of the SGEN Local SEO + AEO landing page,
retargeted from optometry to **dentistry**. This is the dark counterpart of the
light (`SGEN-SEO-AEO-Dental_White`) bundle — **identical dental content, stats, and website samples**,
rendered on SGEN's dark theme. Static HTML/CSS/JS — no build step.

## Pages

| File | Purpose |
|------|---------|
| `index.html` | The dental Local SEO + AEO landing page — **dark theme** |

...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'renew-wellness-spa.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Renew Wellness Spa server running on http://localhost:${PORT}`));

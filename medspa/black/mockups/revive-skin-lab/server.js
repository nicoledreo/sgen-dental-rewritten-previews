...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'revive-skin-lab.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Revive Skin Lab server running on http://localhost:${PORT}`));

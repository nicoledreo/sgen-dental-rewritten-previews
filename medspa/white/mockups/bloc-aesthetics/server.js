...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'bloc-aesthetics.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`BLOC Aesthetics server running on http://localhost:${PORT}`));

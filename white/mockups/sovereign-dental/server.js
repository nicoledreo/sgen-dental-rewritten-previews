...
http.createServer((req, res) => {
  const filePath = path.join(DIR, req.url === '/' ? 'sovereign-dental.html' : req.url.split('?')[0]);
...
}).listen(PORT, () => console.log(`Sovereign Dental server running on http://localhost:${PORT}`));

# SGEN Optometry (Dark) — Local SEO + AEO Landing Page

**Dark/black-theme** editable static bundle of the SGEN Local SEO + AEO landing page, retargeted
to **optometry / eye care**. Cloned from `SGEN-SEO-AEO-Dental_Black_Optimized_V4` and rewritten
against the owner's `Optometry_Landing_Page_Content_Map.xlsx`. This is the dark counterpart of
`SGEN-SEO-Opto_White - Optimized` — identical content, stats and website samples on the light
theme. Static HTML/CSS/JS, no build step.

## Pages

| File | Purpose |
|------|---------|
| `index.html` | The optometry Local SEO + AEO landing page — **dark theme** |
...
```
cd "SGEN-SEO-Opto_Black - Optimized"
